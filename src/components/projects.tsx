  ...
  <section id="projects" className="min-h-screen py-20">
    <div className="container mx-auto px-6 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-red-900 bg-opacity-20 backdrop-blur-lg rounded-lg overflow-hidden shadow-lg" data-aos="flip-left">
          <div className="p-6">
        ...
        <div className="bg-red-900 bg-opacity-20 backdrop-blur-lg rounded-lg overflow-hidden shadow-lg" data-aos="flip-left" data-aos-delay="200">
          <div className="p-6">
        ...
        <div className="bg-red-900 bg-opacity-20 backdrop-blur-lg rounded-lg overflow-hidden shadow-lg" data-aos="flip-left" data-aos-delay="400">
          <div className="p-6">
